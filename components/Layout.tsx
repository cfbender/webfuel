...
const Layout: React.FunctionComponent<Props> = ({ user, children }) => {
  return (
    <div id="layout">
      <Head>
        <title>WebFuel</title>
      ...
      <style jsx global>{`
        ...
        /* ----------------------------------------------
 * Generated by Animista on 2019-12-16 18:10:59
 ...
 */
        ...
        :global(.container) {
          -webkit-animation: fade-in 0.2s cubic-bezier(0.39, 0.575, 0.565, 1)
            both;
